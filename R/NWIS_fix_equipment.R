...
NWIS_fix_equipment <- function(file){
...
files <- list.files('C:/Users/tpritch/OneDrive - Oregon/DEQ - Integrated Report - IR_2026/DataAssembly/NWIS',
                    full.names =  TRUE)

files <- files[ str_detect(files, 'nwis_ph_results')]


map(files, NWIS_fix_equipment, .progress = TRUE)
